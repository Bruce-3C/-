...
def add_layer_shifting(ax):
    ...
    # 字體放大至 14
    ax.text(57, 44, '位移界面', ha='center', color='red', fontsize=14, fontweight='bold')
...
def add_warping(ax):
    ...
    # 字體放大至 14
    ax.text(39, 69, '翹曲', ha='center', color='red', fontsize=14, fontweight='bold')
...
def add_stringing(ax):
    ...
    # 字體放大至 14
    ax.text(87, 69, '拉絲', ha='center', color='red', fontsize=14, fontweight='bold')
...
def add_cracking(ax):
    ...
    # 字體放大至 14
    ax.text(55, 47, '裂紋', ha='center', color='red', fontsize=14, fontweight='bold')
...
def add_off_platform(ax):
    ...
    # 字體放大至 14
    ax.text(47, 20, '脫離位移', ha='center', color='red', fontsize=14, fontweight='bold')
...
def export_twenty_tda_images(defect_type, defect_name):
    ...
    # 字體放大至 14
    ax.text(50, -12, '(a) 原始正常樣本', ha='center', va='top', fontsize=14, fontweight='bold')
    ...
    # 字體放大至 14
    ax.text(50, -12, '(b) 疊加瑕疵特徵\n(幾何參數$\\Gamma_{defect}$)', ha='center', va='top', fontsize=14, fontweight='bold')
    ...
    # 字體放大至 14
    ax.text(50, -12, '(c) 加入環境變異\n(環境參數$\\Delta_{env}$：鏡面反射+陰影)', ha='center', va='top', fontsize=14, fontweight='bold')
    ...
    add_environment_effects(ax)
    # 字體放大至 14
    ax.text(50, -12, '(d) TDA最終擴充樣本\n(納入訓練資料集)', ha='center', va='top', fontsize=14, fontweight='bold')
